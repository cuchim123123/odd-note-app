                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-3.5 flex items-center justify-between gap-4 flex-wrap">
                        <span className="text-[11px] font-medium text-muted-foreground/60">
                          {`${new Date(n.createdAt).toLocaleDateString(undefined, { day: 'numeric', month: 'numeric', year: 'numeric' })}, ${new Date(n.createdAt).toLocaleTimeString(undefined, { hour: '2-digit', minute: '2-digit' })}`}
                        </span>
