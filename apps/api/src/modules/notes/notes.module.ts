...
import { CreateNoteHttpController } from './presentation/http/commands/create-note/create-note.http.controller';
import { UpdateNoteHttpController } from './presentation/http/commands/update-note/update-note.http.controller';
import { DeleteNoteHttpController } from './presentation/http/commands/delete-note/delete-note.http.controller';
import { ShareNoteHttpController } from './presentation/http/commands/share-note/share-note.http.controller';
import { UpdateShareHttpController } from './presentation/http/commands/update-share/update-share.http.controller';
import { RevokeShareHttpController } from './presentation/http/commands/revoke-share/revoke-share.http.controller';
import { SetPasswordHttpController } from './presentation/http/commands/set-password/set-password.http.controller';
import { RemovePasswordHttpController } from './presentation/http/commands/remove-password/remove-password.http.controller';
import { VerifyPasswordHttpController } from './presentation/http/commands/verify-password/verify-password.http.controller';
import { SaveDraftHttpController } from './presentation/http/commands/save-draft/save-draft.http.controller';
import { ClearDraftHttpController } from './presentation/http/commands/clear-draft/clear-draft.http.controller';
import { RenameLabelHttpController } from './presentation/http/commands/rename-label/rename-label.http.controller';
import { DeleteLabelHttpController } from './presentation/http/commands/delete-label/delete-label.http.controller';
import { RestoreRevisionHttpController } from './presentation/http/commands/restore-revision/restore-revision.http.controller';
import { ListNotesHttpController } from './presentation/http/queries/list-notes/list-notes.http.controller';
import { ListSharedWithMeHttpController } from './presentation/http/queries/list-shared-with-me/list-shared-with-me.http.controller';
import { GetNoteByIdHttpController } from './presentation/http/queries/get-note-by-id/get-note-by-id.http.controller';
import { ListSharesHttpController } from './presentation/http/queries/list-shares/list-shares.http.controller';
import { GetProtectionStatusHttpController } from './presentation/http/queries/get-protection-status/get-protection-status.http.controller';
import { GetDraftHttpController } from './presentation/http/queries/get-draft/get-draft.http.controller';
import { GetNoteHistoryHttpController } from './presentation/http/queries/get-note-history/get-note-history.http.controller';
